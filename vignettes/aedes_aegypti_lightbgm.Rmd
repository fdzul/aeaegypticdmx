...
lyrs <- terra::rast("/Users/fdzul/Library/CloudStorage/Dropbox/posdoctorado_INSP/proyectos/risk_zmcdmx_paper/1.datasets/2.layers_models/lyrs_model.tif") |>
...
pred <- terra::crop(x = pred,
                    y = aoi,
                    mask = TRUE)
terra::writeRaster(pred, filename = "10.output/lgbm_aedes_aegypti_bio_clim_2015_2025.tif",
                   overwrite=TRUE)
```
